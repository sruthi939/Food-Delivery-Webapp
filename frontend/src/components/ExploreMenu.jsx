...
const ExploreMenu = ({ category, setCategory }) => {
    return (
        <section id="explore-menu" className="w-4/5 mx-auto !pt-20 !pb-18 flex flex-col items-center">
            ...
            <p className="text-center text-gray-400 text-base md:text-xl leading-8 max-w-2xl !mt-9 animate-fade-in-up delay-100 line-clamp-4">
                ...
                desserts. Every meal is prepared with fresh, high-quality ingredients to deliver exceptional taste and satisfy every craving.
            </p>
            <div className="justify-between grid grid-cols-2 sm:grid-cols-3 md:grid-cols-2 lg:grid-cols-8 gap-8 !mt-22 w-full">
                {menu_list.map((item, index) => {
                    ...
                    return (
                        ...
                        >
                            <div
                                className={`w-30 h-25 rounded-full overflow-hidden border-2 transition-all duration-300 ${isActive
            ...
            <div className="!mt-15 w-full">
                <hr className="border-t border-[#D89A2B]/40" />
            </div>
        </section>
    );
};
